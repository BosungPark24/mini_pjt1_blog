...
public class FileUtils {
	...
	public List<FileEntity> parseFileInfo(MultipartHttpServletRequest request) throws Exception {
		...
		List<FileEntity> fileInfoList = new ArrayList<>();
	...
	public List<FileEntity> parseFileInfo(MultipartFile[] files) throws Exception {
		if (files == null) 
			return null;
